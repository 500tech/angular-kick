...
module.exports = function () {
  ...
  switch (term) {
    case 'about':
      console.log('Command: ' + 'about'.blue);
    ...
    default:
      ...
      console.log('   server    ' + 's   ' + '                  ' + 'Run browserSync server with auto-reload');
      console.log('   build     ' + 'b   ' + '                  ' + 'Build application for production');
      console.log('   test      ' + '    ' + '                  ' + 'Run test suit');
