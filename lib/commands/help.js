...
${'Will concat, minify, uglify and other preparations to files and output the ready-to-use application in /public folder'}.white`);
}
...
${'Open angular-kick documentation in browser (http://www.angular-kick.com)'}.white`);
}
