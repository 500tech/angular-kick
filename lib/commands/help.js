...
function setup() {
  console.log('Command: ' + 'setup'.blue + ' or ' + 'set'.blue);
...
function help() {
  ...
  console.log('   setup      ' + 'set    ' + '                  ' + 'Download node and bower packages');
  ...
  console.log('   upgrade     ' + 'u      ' + '                  ' + 'Check for new angular-kick version');
