...
function directive(name, args, opts) {
  let template = (opts.template || opts.t);
...
function state(name, args, opts) {
  let noController = (opts.noController || opts.nc || opts.anc || opts.nca);
  let abstract     = (opts.abstract || opts.a || opts.anc || opts.nca);
...
function partial(name, args, opts) {
  let controller = (opts.controller || opts.c);
