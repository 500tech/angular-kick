...
module.exports = function () {
  ...
  copy(ROOT + '/templates/app', appFolderName, function (error) {
    ...
    logger.create (appFolderName + '/test/unit/controllers/home/home_controller.spec.js');
    ...
    logger.create (appFolderName + '/test/unit/services/layout_spec.js');
    ...
    logger.create (appFolderName + '/production_tasks.js');
