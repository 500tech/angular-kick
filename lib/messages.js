...
module.exports = {
  ...
  new: {
    ...
    overrideQuestion: 'Remove remove it and create a new one?'.white,
    didNotOverride: 'Did not override existing application'
  },

  server: {
    running: 'Running browserSync server on ' + 'http://localhost:3001/'.white,
    testsRunning: 'Running Karma test server on ' + 'http://localhost:9876/'.white,
    stop: 'Press ' + 'CTRL+C'.red + ' to stop'
  },

  setup: {
    downloadingNpm: 'Downloading npm packages (approx. 170MB), this usually takes 5–7 minutes...'.white,
    downloadingBower: 'Downloading bower packages (approx. 2MB), this usually takes less than a minute...'.white,
