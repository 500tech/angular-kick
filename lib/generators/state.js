...
module.exports = function (name, noController, abstract) {
  ...
  function generateState (stateName) {
    ...
    if (stateName === rootState) {
      ...
      templates.createDirectory('app/states/' + statePath + stateName);
    }
    ...
    if (!noController) {
      templates.createFile('app/states/' + statePath + format.toJSFileName(stateName + '_controller'),
    ...
    if (!noController) {
      ...
      templates.createFile('test/unit/controllers/' + statePath + format.toJSFileName(stateName + '_controller_spec'),
