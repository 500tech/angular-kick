...
module.exports = function (name) {
  ...
  if (!parentStates.length) {
    ...
    utils.modifyFile('app/config/routes/routes.js', "import { " + rootState + "Routes } from './" + format.toFolderName(rootState) + "';\n", '');
  ...
  function destroyState (stateName) {
    ...
    utils.removeFromFile('app/config/config.js', "require('./routes/" + rootState + "');\n");
    utils.removeFromFile('app/states/states.js', "require('./" + statePath + stateName + ".controller');");
