...
module.exports = {
  ...
  directiveWithTemplate: function (locals) {
    return fs.readFileSync(ROOT + '/templates/directive_with_template.js', 'utf8')
      .replace(/%DIRECTIVE_NAME%/g, locals.directiveName)
      .replace(/%DIRECTIVE_TEMPLATE_URL%/g, locals.directiveTemplateUrl)
      .replace(/%APP_NAME%/g, appName);
  },

  directiveTemplate: function (locals) {
    return fs.readFileSync(ROOT + '/templates/directive_template.html', 'utf8')
      .replace(/%DIRECTIVE_NAME%/g, locals.directiveName);
  },
  ...
  controller: function (locals) {
    return fs.readFileSync(ROOT + '/templates/controller.js', 'utf8')
      .replace(/%CONTROLLER_NAME%/g, locals.controllerName)
      .replace(/%CONTROLLER_VARIABLE%/g, locals.controllerVariable)
      .replace(/%APP_NAME%/g, appName);
  },
  ...
  model: function (locals) {
    return fs.readFileSync(ROOT + '/templates/model.js', 'utf8')
      .replace(/%MODEL_NAME%/g, locals.modelName)
      .replace(/%APP_NAME%/g, appName);
  },
  ...
  testModelUnit: function (locals) {
    return fs.readFileSync(ROOT + '/templates/test/model_unit_spec.js', 'utf8')
      .replace(/%MODEL_NAME%/g, locals.modelName)
      .replace(/%APP_NAME%/g, appName);
  },
