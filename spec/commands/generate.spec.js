...
describe('$ kick generate', function () {
  ...
  it('should generate config', function () {
    ...
    var configFile = fs.readFileSync('app/config/example.js');
  ...
  it('should generate directive', function () {
    ...
    var file = fs.readFileSync('app/directives/example.js');
    var specFile = fs.readFileSync('test/unit/directives/example.spec.js');
  ...
  it('should generate directive with template', function () {
    ...
    var file = fs.readFileSync('app/directives/example.js');
    var template = fs.readFileSync('app/directives/example.html');
    var specFile = fs.readFileSync('test/unit/directives/example.spec.js');
  ...
  it('should generate environment', function () {
    ...
    var file = fs.readFileSync('environments.json');
  ...
  it('should generate filter', function () {
    ...
    var file = fs.readFileSync('app/filters/example.js');
    var specFile = fs.readFileSync('test/unit/filters/example.spec.js');
  ...
  it('should generate model', function () {
    ...
    var file = fs.readFileSync('app/models/example.js');
    var specFile = fs.readFileSync('test/unit/models/example.spec.js');
  ...
  it('should generate partial', function () {
    ...
    var file = fs.readFileSync('app/layouts/shared/_example.html');
  ...
  it('should generate partial with controller', function () {
    ...
    var controller = fs.readFileSync('app/layouts/shared/_example_2.controller.js');
  ...
  it('should generate service', function () {
    ...
    var file = fs.readFileSync('app/services/example.js');
    var specFile = fs.readFileSync('test/unit/services/example.spec.js');
  ...
  it('should generate state', function () {
    ...
    var route       = fs.readFileSync('app/config/routes/example.js');
    var style       = fs.existsSync('app/assets/stylesheets/example.scss');
    var mainStyle   = fs.readFileSync('app/assets/stylesheets/application.scss');
    var view        = fs.readFileSync('app/states/example/example.html');
    var controller  = fs.readFileSync('app/states/example/example.controller.js');
    var spec        = fs.readFileSync('test/unit/controllers/example/example.controller.spec.js');
  ...
  it('should generate abstract state', function () {
    ...
    var route = fs.readFileSync('app/config/routes/example_2.js');
  ...
  it('should generate state without controller', function () {
    ...
    var route = fs.readFileSync('app/config/routes/abs_example_3.js');
  ...
  it('should generate style', function () {
    ...
    var mainFile = fs.readFileSync('app/assets/stylesheets/application.scss');
